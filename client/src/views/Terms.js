...
const Terms = (props) => {
  return (
    <div>
      <h1 className="request-info">Terms and Conditions</h1>
      <p>Last updated: August 10, 2020</p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to 3DP, accessible from{" "}
            <a
              href="www.3dreamprint.com"
      ...
      <h1 className="request-info">Acknowledgment</h1>
      <p>
      ...
      <h1 className="request-info">Links to Other Websites</h1>
      <p>
      ...
      <h1 className="request-info">Termination</h1>
      <p>
      ...
      <h1 className="request-info">Limitation of Liability</h1>
      <p>
      ...
      <h1 className="request-info">Governing Law</h1>
      <p>
      ...
      <h1 className="request-info">Disputes Resolution</h1>
      <p>
      ...
      <h1 className="request-info">For European Union (EU) Users</h1>
      <p>
        If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which you are resident
        in.
      </p>
      <h1 className="request-info">United States Legal Compliance</h1>
      <p>
      ...
      <h1 className="request-info">Translation Interpretation</h1>
      <p>
      ...
      <h1 className="request-info">Changes to These Terms and Conditions</h1>
      <p>
      ...
      <h1 className="request-info">Contact Us</h1>
      <p>
        If you have any questions about these Terms and Conditions, You can
        contact us:
      </p>
      <ul>
        <li>By email: Farisalahmad01@hotmail.com</li>
      </ul>
    </div>
  );
};
